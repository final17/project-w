...
public enum FoodKindCategory implements HierarchicalCategory {

    ROOT("food_kind", "FOOD_KIND", "F", null);
    ...
    FoodKindCategory(String type, String name, String code, HierarchicalCategory parent) {
        this.type = type;
        this.name = name;
        this.parent = parent;
        this.code = code;
